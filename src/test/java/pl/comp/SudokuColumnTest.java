<<<<<<< HEAD:src/test/java/pl/comp/SudokuColumnTest.java
/**
...
class SudokuColumnTest {
    ...
    void testEquals() {
        ...
        // cohesion
        assertEquals(sudokuColumn1.equals(sudokuColumn2), sudokuColumn1.equals(sudokuColumn2));
    }
    ...
    void testHashCode() {
        ...
        // cohesion
        var hashCode = sudokuColumn1.hashCode();
        assertEquals(hashCode, sudokuColumn1.hashCode());
    }
...
class SudokuColumnTest {
    ...
    void cloneTest() throws CloneNotSupportedException {
        SudokuElement se = sudokuColumn1.clone();
        assertEquals(se.getSudokuFields(), sudokuColumn1.getSudokuFields());
        assertNotSame(se, sudokuColumn1);
    }
>>>>>>> origin/ViewFX:Model/src/test/java/pl/comp/model/SudokuColumnTest.java
}